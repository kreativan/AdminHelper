...
$title = !empty($input->get->title) ? $sanitizer->text($input->get->title) : $p->title;
?>

<div id="htmx-modal" class="page-edit-modal uk-flex-top <?= $container ? 'uk-modal-container' : '' ?>" uk-modal="bg-close: true">
  <div class="uk-modal-dialog uk-overflow-hidden uk-margin-auto-vertical uk-width-2xlarge" style="height:<?= $height ?>">
